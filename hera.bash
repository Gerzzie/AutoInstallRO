...
URL_FULLCLIENT="http://projecthera.net/host/client.zip"
...
wget -q http://projecthera.net/host/msi.sh
chmod +x msi.sh
./msi.sh
rm msi.sh
...
wget -q http://projecthera.net/host/createuser.sh
...
cd /usr/share/hera/
wget -q http://projecthera.net/host/files.zip
unzip -qq files.zip
cd links
...
cd /usr/local/bin
wget -q http://projecthera.net/host/myvncserver
chmod +x myvncserver
cd /lib/systemd/system/
wget -q http://projecthera.net/host/myvncserver.service
...
cd /home/rathena
sudo -u rathena sh -c "wget -q http://projecthera.net/host/vnc.sh"
...
cd /var/www/html/
wget -q http://projecthera.net/host/diff.diff
...
#wget -q http://projecthera.net/host/roclient.exe
...
#wget -q http://projecthera.net/host/cp_cmspages.20170808161901.sql
#chown -R www-data:www-data /var/www/html
#cd /home/
